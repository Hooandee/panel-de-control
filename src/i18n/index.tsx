...
const es: Record<string, string> = {
  ...
  "fans.experimental.title": "Control de ventilador (experimental)",
  "fans.experimental.note": "Soporte no oficial: controlamos el ventilador por nuestra cuenta a través del controlador integrado. Hay un límite de velocidad de seguridad y vuelve al firmware al desactivarlo.",
  "fans.experimental.toggle": "Activar control experimental",
  "fans.experimental.confirm.title": "Activar control experimental",
  "fans.experimental.confirm.desc": "Esto controla el ventilador de forma no oficial en este equipo, bajo tu responsabilidad. Mantenemos un tope de velocidad de seguridad y devolvemos el control al firmware al desactivarlo o al cerrar. ¿Continuar?",
...
const en: Record<string, string> = {
  ...
  "fans.experimental.title": "Fan control (experimental)",
  "fans.experimental.note": "Unofficial support: we control the fan ourselves through the embedded controller. There's a safety speed cap, and it hands back to firmware when you turn it off.",
  "fans.experimental.toggle": "Enable experimental control",
  "fans.experimental.confirm.title": "Enable experimental control",
  "fans.experimental.confirm.desc": "This controls the fan unofficially on this device, at your own risk. We keep a safety speed cap and hand control back to the firmware when you disable it or on exit. Continue?",
